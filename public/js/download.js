...
const renderOverlayErrorMessage = (msg, secondary_msg = null) => {
    ...
    `
    child.innerHTML += `<h1 class="text-center text-2xl text-secondary">${msg}</h1>`
    if (secondary_msg) {
        child.innerHTML += `<h1 class="text-center text-lg text-secondary">${secondary_msg}</h1>`
    }
    child.innerHTML += `<h1 class="text-center text-lg"><a class="text-secondary text-decoration-none" href="index.html">return to home page</a></h1>`
