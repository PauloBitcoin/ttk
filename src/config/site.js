...
export const SITE = {
  name: 'DinoTok Downloader',
  shortName: 'DinoTok',
  domain: 'bbft.live',
  tagline: 'Download TikTok videos without watermark free.',
  description:
    'Download TikTok videos without watermark! DinoTok Downloader is the best app to download videos and music from TikTok without watermark, online, free and without ads.',
}
