...
export function Navbar() {
  ...
  return (
    <>
      <nav className="sticky top-0 z-30 flex h-24 items-center justify-between border-b border-black/5 bg-white/70 p-2 backdrop-blur-lg dark:border-zinc-800/60 dark:bg-zinc-950/70">
